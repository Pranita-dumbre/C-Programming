...
//  Description :       Prints a rectangular grid of asterisks (*) based
//                      on the number of rows (iRow) and columns (iCol)
//                      provided by the user. Uses nested loops where the
//                      outer loop controls rows and the inner loop controls
//                      columns.
//  Author :            Pranita Purushottam Dumbre
//  Date :              11/06/2026 
//
