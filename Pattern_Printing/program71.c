...
//                      printed above the secondary diagonal and '*'
//                      is printed on and below the secondary diagonal.
...
//
//  Method Name :     Display
//  Description :     prints a square matrix pattern by traversing the columns
//                    in reverse order. 'o' is printed above the secondary
//                    diagonal, while '*' is printed on and below
